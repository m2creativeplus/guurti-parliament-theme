...
import { 
  ...
  Activity, Radio, Target, Briefcase, BarChart, Server, Terminal, Play, Loader2, Cloud
} from 'lucide-react';
      ...
      <div className="min-h-screen bg-[#050507] text-[#F0EEE8] font-body selection:bg-mora-green-500/30">
        ...
        <header className="sticky top-0 z-20 border-b border-mora-green-900/50 bg-[#050507]/90 backdrop-blur-xl px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/epd/workspace" className="flex items-center gap-2 border border-sl-gold-400/30 hover:border-sl-gold-400/60 bg-sl-gold-400/5 hover:bg-sl-gold-400/10 text-sl-gold-400 px-5 py-2.5 rounded-xl font-bold transition-all text-sm">
              <Cloud className="w-4 h-4" /> Workspace
            </Link>
